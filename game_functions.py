...
def update_bullets(aliens, bullets, ai_settings, screen):
	...
	check_bullet_alien_collision(aliens, bullets, ai_settings, screen)
	
def check_bullet_alien_collision(aliens, bullets, ai_settings, screen):
